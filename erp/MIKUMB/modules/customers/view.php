...
<div class="customer-header">
    <div class="container-fluid">
        <div class="row align-items-center">
            ...
            <div class="col-auto">
                <a href="edit.php?id=<?php echo $customer_id; ?>" class="btn btn-light me-2">
        ...
        <div class="tab-pane fade show active" id="overview">
            ...
            <div class="info-card">
                ...
                <div class="info-row">
                    ...
                    <div class="info-value">
                        <a href="tel:<?php echo htmlspecialchars($customer['alternative_phone']); ?>">
                            <?php echo htmlspecialchars($customer['alternative_phone']); ?>
                        </a>
                    </div>
                </div>
                <?php endif; ?>
                ...
                <div class="info-row">
                    ...
                    <div class="info-value"><?php echo ucfirst($customer['gender']); ?></div>
                </div>
                <?php endif; ?>
                ...
                <div class="col-md-6">
                    <div class="info-card">
                        ...
                        <div class="info-row">
                            ...
                            <div class="info-value">
                                <?php echo htmlspecialchars($customer['guardian1_name']); ?>
                                <?php if ($customer['guardian1_relationship']): ?>
                                    <br><small class="text-muted">(<?php echo ucfirst($customer['guardian1_relationship']); ?>)</small>
                                <?php endif; ?>
                            </div>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="info-row">
                            ...
                            <div class="info-value">
                                <?php echo htmlspecialchars($customer['guardian2_name']); ?>
                                <?php if ($customer['guardian2_relationship']): ?>
                                    <br><small class="text-muted">(<?php echo ucfirst($customer['guardian2_relationship']); ?>)</small>
                                <?php endif; ?>
                            </div>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="info-row">
                            ...
                            <div class="info-value">
                                <a href="tel:<?php echo htmlspecialchars($customer['next_of_kin_phone']); ?>">
                                    <?php echo htmlspecialchars($customer['next_of_kin_phone']); ?>
                                </a>
                            </div>
                        </div>
                        <?php endif; ?>
        ...
        <div class="tab-pane fade" id="reservations">
            <div class="table-card">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <a href="../sales/create.php?customer_id=<?php echo $customer_id; ?>" class="btn btn-primary">
