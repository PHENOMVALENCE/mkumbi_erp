...
$sql = "SELECT 
    ...
    COALESCE(SUM(pc.cost_amount), 0) as total_costs
FROM projects p
...
if (!empty($search_query)) {
    $sql .= " AND (p.project_name LIKE ? OR p.project_code LIKE ? OR p.physical_location LIKE ?)";
        ...
        <div class="row g-3 mb-4">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="stats-card warning">
                    <div class="stats-number"><?php echo number_format(($stats['total_area'] ?? 0) / 10000, 1); ?> Ha</div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge bg-light text-dark">
                                        <?php echo number_format($project['total_area'] ?? 0); ?> m²
                                    </span>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="fw-semibold text-success">
                                        TSH <?php echo number_format($project['total_investment'] ?? 0); ?>
                                    </div>
                                    <small class="text-muted">
...
$(document).ready(function() {
    // Only initialize DataTable if table has data rows
