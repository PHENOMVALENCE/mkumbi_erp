...
<div class="content-header">
    <div class="container-fluid">
        <div class="row align-items-center mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">
                    <i class="fas fa-plus-circle text-primary"></i> Add New Plot
                </h1>
...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="alert alert-success alert-dismissible fade show" role="alert">
            ...
            <p class="mb-0 mt-2"><i class="fas fa-spinner fa-spin"></i> Redirecting to plots list...</p>
            <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
        </div>
        <?php endif; ?>
        ...
        <form method="POST" id="plotForm">
            ...
            <div class="form-section">
                ...
                <div class="row g-2">
                    <div class="col-12">
                        <label class="form-label required-field">
                            Select Project
                            <span class="auto-fill-badge"><i class="fas fa-magic"></i> Auto-fills</span>
                        </label>
                        <select name="project_id" id="project_id" class="form-select form-select-sm" required onchange="loadProjectInfo()">
                ...
                <div id="projectInfoDisplay" class="project-info-display">
                    <h6 class="mb-2" style="font-size: 0.9rem;"><i class="fas fa-info-circle text-primary"></i> Project Information</h6>
                ...
                <div class="row g-2">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" 
                               ...
                               value="<?php echo htmlspecialchars($_POST['coordinates'] ?? ''); ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <div class="row g-2">
                    ...
                    <div class="col-md-4">
                        <label class="form-label required-field">
                            Selling Price (TSH)
                            <span class="auto-fill-badge"><i class="fas fa-magic"></i> Auto-calc</span>
                        </label>
                        <input type="number" 
                               name="selling_price" 
                               id="selling_price"
            ...
            <div class="form-section">
                ...
                <div class="row g-2">
                    ...
                    <div class="col-md-6">
                        <div class="form-check" style="margin-top: 1.85rem;">
                            ...
                            <label class="form-check-label" for="corner_plot">
                                ...
                                <small class="text-muted d-block">Usually premium pricing</small>
                            </label>
                        </div>
                    </div>
...
function loadProjectInfo() {
    ...
    if (projectSelect.value) {
        ...
        if (hasError) {
            ...
            submitBtn.innerHTML = '<i class="fas fa-ban"></i> Cannot Create - Limit Reached';
            ...
            submitBtn.innerHTML = '<i class="fas fa-save"></i> Create Plot';
...
function validatePlotArea() {
    ...
    if (plotArea > remainingArea) {
        ...
        submitBtn.disabled = true;
        submitBtn.innerHTML = '<i class="fas fa-ban"></i> Area Exceeded';
